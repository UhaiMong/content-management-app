      ...
      <dh-component>
        <nav className="w-full border-b">
          <div className="py-5 md:py-0 container mx-auto px-6 flex items-center justify-between">
            <div aria-label="Home. logo" role="img" className="w-28 h-28">
              <img
                className="w-full"
                src={logo}
                alt="logo"
          ...
          <div className="container mx-auto flex flex-col items-center py-12 sm:py-40">
            <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
              ...
              <p className="mt-5 sm:mt-10 lg:w-10/12 text-gray-400 font-normal text-center text-sm sm:text-lg">
                Your blogs your freedom. Explore now some awesome blogs that can change your life. We included the topic creative , development, skills, programming and love.{" "}
              </p>
            </div>
